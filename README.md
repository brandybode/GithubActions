[![Run App <Bode>, <Brandy>](https://github.com/brandybode/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/brandybode/GithubActions/actions/workflows/ci.yml)
